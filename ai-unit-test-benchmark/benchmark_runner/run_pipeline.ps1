...
# ==============================================================================
# PHASE 1: INITIAL WORKFLOWS (single, single_loop, agent, agent_loop, ultimate_hybrid)
# ==============================================================================
Write-Host "`n>>> [PHASE 1] RUNNING INITIAL WORKFLOWS (single, single_loop, agent, agent_loop, ultimate_hybrid) <<<" -ForegroundColor Green
...
Write-Host "Running V2 Single-Pass + Loop Workflow..." -ForegroundColor Yellow
py main.py --version v2 --model gptmini --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/gptmini/run_log_single_loop.txt
py main.py --version v2 --model llama --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/llama/run_log_single_loop.txt
py main.py --version v2 --model deepseekv3 --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/deepseekv3/run_log_single_loop.txt
...
Write-Host "Running V2 Agent + Loop Workflow..." -ForegroundColor Yellow
py main.py --version v2 --model gptmini --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/gptmini/run_log_agent_loop.txt
py main.py --version v2 --model llama --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/llama/run_log_agent_loop.txt
py main.py --version v2 --model deepseekv3 --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v2/deepseekv3/run_log_agent_loop.txt
...
#rite-Host "Running V1 Single-Pass + Loop Workflow..." -ForegroundColor Yellow
#py main.py --version v1 --model gptmini --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/gptmini/run_log_single_loop.txt
#py main.py --version v1 --model llama --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/llama/run_log_single_loop.txt
#py main.py --version v1 --model deepseekv3 --workflow single_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/deepseekv3/run_log_single_loop.txt
...
#Write-Host "Running V1 Agent + Loop Workflow..." -ForegroundColor Yellow
#py main.py --version v1 --model gptmini --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/gptmini/run_log_agent_loop.txt
#py main.py --version v1 --model llama --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/llama/run_log_agent_loop.txt
#py main.py --version v1 --model deepseekv3 --workflow agent_loop --enable-mutation --skip-existing 2>&1 | Tee-Object -Append results/logs/v1/deepseekv3/run_log_agent_loop.txt
